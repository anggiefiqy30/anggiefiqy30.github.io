<?php
	...
	{
		$query = mysql_query("SELECT * FROM alternatif WHERE kode_alternatif = '$_POST[kode_alternatif]'");
		if (!$data = mysql_fetch_array($query))
		{
			mysql_query("INSERT INTO alternatif(kode_alternatif, nama_alternatif, ket) VALUES('$_POST[kode_alternatif]', '$_POST[nama_alternatif]', '$_POST[ket]')");
