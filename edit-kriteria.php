<?php
	...
	{
		mysql_query("UPDATE kriteria SET nama_kriteria = '$_POST[nama_kriteria]'  WHERE kode_kriteria = '$_POST[kode_kriteria]'");
						...
						<table width="1000" class="table">
						  <tr>
						    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
						      ...
						      <br />
						      <?php
									$querykriteria = mysql_query("SELECT * FROM kriteria WHERE kode_kriteria = '$_GET[kode_kriteria]'");
