						  ...
						  <tr>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="del-alternatif?kode_alternatif=<?php echo $dt['kode_alternatif']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')"><span class="glyphicon glyphicon-trash"></span></a>
								</td>
							</tr>
							<?php
							$no++;
